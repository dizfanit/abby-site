...
const LEFT_BANNERS = [
  {
    ...
    accent: "#FA5108",
    bg: "#1A1A2E",
    img: "/remote-images/unsplash-026.jpg",
  ...
  },
  {
    ...
    accent: "#2563EB",
    bg: "#0F172A",
    img: "/remote-images/unsplash-024.jpg",
  ...
  },
  {
    ...
    accent: "#7C3AED",
    bg: "#1E1B2E",
    img: "/remote-images/unsplash-039.jpg",
    badge: "Новинка",
    discount: "Акция\nдо 31.03",
  },
  {
    ...
    accent: "#0891B2",
    bg: "#0C1A1E",
    img: "/remote-images/unsplash-029.jpg",
    badge: "Хит продаж",
    discount: "Рассрочка\n0% · 12 мес",
  },
  {
    ...
    accent: "#DC2626",
    bg: "#1C0404",
    img: "/remote-images/unsplash-044.jpg",
    badge: "Сезон открыт",
    discount: "−10%\nдо мая",
  },
  {
    ...
    accent: "#16A34A",
    bg: "#061408",
    img: "/remote-images/unsplash-011.jpg",
    badge: "500+ бригад",
    discount: "Выезд\nсегодня",
  },
];
...
const RIGHT_BANNERS = [
  {
    ...
    accent: "#059669",
    bg: "#052E16",
    img: "/remote-images/unsplash-015.jpg",
    badge: "Выгода месяца",
    discount: "−20%\nна монтаж",
  },
  {
    ...
    accent: "#D97706",
    bg: "#1C1400",
    img: "/remote-images/unsplash-014.jpg",
    badge: "24/7 выезд",
  ...
  },
  {
    ...
    accent: "#B45309",
    bg: "#1C0A00",
    img: "/remote-images/unsplash-009.jpg",
    badge: "VIP",
    discount: "Рассрочка\n0%",
  },
  {
    ...
    accent: "#6D28D9",
    bg: "#130D24",
    img: "/remote-images/unsplash-023.jpg",
    badge: "Новинка 2026",
    discount: "Монтаж\nбесплатно",
  },
  {
    ...
    accent: "#0284C7",
    bg: "#061622",
    img: "/remote-images/unsplash-018.jpg",
  ...
  },
  {
    ...
    accent: "#15803D",
    bg: "#071610",
    img: "/remote-images/unsplash-038.jpg",
    badge: "Сезон открыт",
...
const LEFT_EXTRA: ExtraBanner[] = [
  // Style A – "Poster": full-bleed photo, gradient overlay, cinematic feel
  {
    id: "lx1",
    style: "poster",
    img: "/remote-images/unsplash-022.jpg",
    label: "Недвижимость",
    headline: "Квартиры\nбизнес-класса\nот 5.2 млн ₽",
...
const RIGHT_EXTRA: ExtraBanner[] = [
  // Style A – "Poster": dark moody photo, bold typography
  {
    id: "rx1",
    style: "poster",
    img: "/remote-images/unsplash-040.jpg",
    label: "Вакансии",
    headline: "Найди\nработу\nв строительстве",
